            ...
            <div class="col">
                ...
                $menupaket =
                    [
                        [
                            'nama_paket' => 'paket 2',
                            'makanan' => 'nasi biasa, ayam dada, ayam paha,',
                            'minuman' => 'coca cola',
                            'harga_paket' => 'Rp 25000'
                        ],
                    ];
                ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" action="hasil.php">
                                    ...
                                    <div>
                                        <input type="hidden" name="namapaket" value="Paket 2, <?= $paket['makanan'] ?> + <?= $paket['minuman'] ?>">
                                    </div>
                                    <div class="mb-3">
